...
const ADMIN_CONN_STRING = "mongodb://root:example@127.0.0.1:27017?w=majority";
const CALCULATION_COLLECTION = "calculations";

module.exports = {
    DB_WORKSHOP_CONSTANTS: {
        user: WORKSHOP_USER,
        pass: WORKSHOP_PASS,
        workshopDbName: WORKSHOP_DB_NAME,
        adminDbName: ADMIN_DB_NAME,
        adminConnString: ADMIN_CONN_STRING,
        workshopConnString: `mongodb://${WORKSHOP_USER}:${WORKSHOP_PASS}@127.0.0.1:27017/${WORKSHOP_DB_NAME}?w=majority`,
